...
<body class="bg-gray-50 font-sans antialiased" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen overflow-hidden">
        ...
        >
            <!-- Logo -->
            <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200 bg-emerald-600">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="text-white">
                        <h1 class="text-lg font-bold leading-tight">Glow FM</h1>
                ...
                @foreach($section['items'] as $item)
                    <div x-data="{ open: false }">
                        @if(isset($item['children']))
                            ...
                            <button 
                                @click="open = !open"
                                class="w-full flex items-center justify-between px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition-colors duration-150"
                            >
                                <div class="flex items-center space-x-3">
