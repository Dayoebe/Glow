                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-{{ $category->color }}-100 rounded-lg flex items-center justify-center">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <button wire:click="toggleStatus({{ $category->id }})"
                                    ...
                                    <i
                                        class="fas {{ $category->is_active ? 'fa-check-circle' : 'fa-times-circle' }} mr-1"></i>
                            ...
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-400 text-sm">
                                        {{ !empty($search) ? 'Try adjusting your search' : 'Get started by creating your first category' }}
                                    </p>
                                </div>
                            </td>
                        </tr>
    ...
    <div x-show="showFormModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showFormModal" x-transition:enter="ease-out duration-300"
                ...
                class="relative z-10 inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <!-- Header -->
                ...
                <form wire:submit.prevent="save">
                    <div class="px-6 py-6 space-y-6 max-h-[70vh] overflow-y-auto">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-5 sm:grid-cols-10 gap-2">
                                @foreach ($availableIcons as $iconOption)
                                    <button type="button" wire:click="$set('icon', '{{ $iconOption }}')"
                                        ...
                                        <i
                                            class="{{ $iconOption }} text-xl {{ $icon === $iconOption ? 'text-emerald-600' : 'text-gray-600' }}"></i>
                                        @if ($icon === $iconOption)
                                            <div
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                @foreach ($availableColors as $colorValue => $colorName)
                                    <button type="button" wire:click="$set('color', '{{ $colorValue }}')"
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <div class="w-8 h-8 rounded-lg bg-{{ $colorValue }}-500 shadow-sm">
                                            </div>
                        ...
                        <!-- Preview Card -->
                        <div
                            class="mb-5 p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200">
                        ...
                        <div
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <div
                                    class="w-14 h-7 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-200 rounded-full peer peer-checked:after:translate-x-7 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-emerald-600 shadow-inner">
                                </div>
                            </label>
                        </div>
                    </div>
