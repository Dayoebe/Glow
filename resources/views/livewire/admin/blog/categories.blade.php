                ...
                <div class="bg-white px-6 py-6 max-h-[calc(100vh-200px)] overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.live="name"
                                ...
                                placeholder="e.g., Music Insights">
                            @error('name') 
                    ...
                    <div class="mb-5">
                        ...
                        <textarea wire:model="description" rows="3"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all resize-none"
                        ...
                        <div class="grid grid-cols-5 sm:grid-cols-10 gap-2">
                            @foreach($availableIcons as $iconOption)
                                <button type="button" 
                                    ...
                                    class="group relative p-3 border-2 rounded-xl transition-all duration-200 {{ $icon === $iconOption ? 'border-purple-500 bg-purple-50 shadow-md scale-105' : 'border-gray-200 hover:border-purple-300 hover:bg-gray-50' }}">
                                    <i class="{{ $iconOption }} text-xl {{ $icon === $iconOption ? 'text-purple-600' : 'text-gray-600 group-hover:text-purple-500' }}"></i>
                                    @if($icon === $iconOption)
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            @foreach($availableColors as $colorValue => $colorName)
                                <button type="button" 
                                    ...
                                    class="relative p-4 border-2 rounded-xl transition-all duration-200 {{ $color === $colorValue ? 'border-purple-500 bg-purple-50 shadow-md' : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50' }}">
                                    <div class="flex items-center space-x-3">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="w-14 h-7 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-200 rounded-full peer peer-checked:after:translate-x-7 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-purple-600 shadow-inner"></div>
                        </label>
                    </div>
                </div>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Are you sure you want to delete this category? This action cannot be undone. Categories with existing blog posts cannot be deleted.
                                    </p>
                                </div>
                            </div>
                        </div>
