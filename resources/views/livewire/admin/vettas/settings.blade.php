<div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Reservation Notification Email</label>
                <input type="email" wire:model="contact.reservation_notification_email"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    placeholder="chairman@glowfmradio.com">
                <p class="mt-2 text-xs text-gray-500">New Vettas reservation requests will be emailed to this address automatically.</p>
                @error('contact.reservation_notification_email') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
            </div>
