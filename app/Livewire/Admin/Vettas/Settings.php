...
class Settings extends Component
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'contact.reservation_notification_email' => 'nullable|email|max:150',
    ...
    public function save(): void
    {
        ...
        $payload = [
            ...
            'contact' => [
                ...
                'reservation_notification_email' => $this->normalizeString($this->contact['reservation_notification_email'] ?? ''),
